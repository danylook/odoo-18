...
class PaymentProvider(models.Model):
    ...
    code = fields.Selection(
        selection_add=[('mercado_pago_uy', 'Mercado Pago Uruguay')],
        ondelete={'mercado_pago_uy': 'set default'}
    )
    mercado_pago_uy_access_token = fields.Char(
        string="Mercado Pago Uruguay Access Token",
        required_if_provider='mercado_pago_uy',
    ...
    def _get_supported_currencies(self):
        ...
        if self.code == 'mercado_pago_uy':
            supported_currencies = supported_currencies.filtered(
                lambda c: c.name in const.SUPPORTED_CURRENCIES
            )
        return supported_currencies

    def _mercado_pago_uy_make_request(self, endpoint, payload=None, method='POST'):
        ...
        headers = {
            'Authorization': f'Bearer {self.mercado_pago_uy_access_token}',
            ...
            if method == 'GET':
                ...
                try:
                    ...
                    try:
                        ...
                        raise ValidationError("Mercado Pago Uruguay: " + _(
    ...
    #     """Permite publicar/despublicar el método de pago para 'mercado_pago_uy' igual que para otros providers."""
    #     self.ensure_one()
    #     if self.code == 'mercado_pago_uy':
